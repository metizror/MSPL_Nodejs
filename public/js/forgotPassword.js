$(document).ready(function () {
    var uniqueToken = getParameterByName('unq_tkn');
    var passwordToken = getParameterByName('pwd_tkn');
    ...
    $.ajax({
        type: "POST",
        url: url + '/api/admin/adminVerifyLink',
        dataType: "JSON",
        data: {
            '_id': uniqueToken,
    ...
    $('#btn1').on("click", function () {
        ...
        if ($('#password').val() == '' || $('#password').val() == null) {
            ...
            $.ajax({
                type: "POST",
                url: url + '/api/admin/adminUpdatePassword',
                dataType: "JSON",
                data: {
                    '_id': uniqueToken,
                    'passwordResetToken': passwordToken,
